...
var province = document.getElementById('collegesSelect');
createOption(collegesSelect,collegesSelectArr);
var majorSelec = document.getElementById('majorSelect');
collegesSelect.onchange = function() {
    majorSelec.options.length = 0;
    createOption(majorSelec,majorSelectArr[collegeSelec.value]);
};
var classSelect = document.getElementById('classSelect');
majorSelect.onchange = function() {
    classSelect.options.length = 0;
    createOption(classSelect,classSelectArr[province.value] [majorSelec.value]);
};
